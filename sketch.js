...
/* Romina Alejandra González */
/* Link pagina: */
/* Link Youtube: https://youtu.be/eCtI7sYkjqE?si=I_q1N1E2aIQnMlKh */
...
function draw() {
  ...
  if (gameState === 'nameEntry') {
    ...
    if (frameCount % 30 === 0) {
      ...
      if (gameLevel === 'easy' && random(1) < 0.05) {
...
text('Preciona 0 para ver las instrucciones', width / 2, height / 2 + 220);
  text('Preciona 5 para ver los creditos', width / 2, height / 2 + 195);
  pop();
}
